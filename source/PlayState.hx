...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Just Go Play Something Else Please', 0.4], //From 20% to 39%
		['I Swear Its Not Overcharted', 0.5], //From 40% to 49%
		['Wtf Are You Doing', 0.6], //From 50% to 59%
		['Not Bad', 0.69], //From 60% to 68%
		['Funny Number', 0.7], //69%
		['Uh You Okay?', 0.8], //From 70% to 79%
		['Nice', 0.9], //From 80% to 89%
		['Cool!', 1], //From 90% to 99%
		['Oh Wow', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
